...
Download `tab_management_agent_bridge_for_firefox-0.5.9.xpi` from the [latest release](https://github.com/Johnnyzlee/agent-bridge-for-tab-management-in-firefox/releases) and open it with Firefox.
